...
public class NotesSearch extends ActionBarActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setQueryHint("Tasting Notes");
        wineList = (ListView) findViewById(R.id.wineResults);
        wineList.setAdapter(mAdapter = new WineListArrayAdapter(this, R.layout.wine_list_layout, wines, Search.TASTING_NOTES_CALL ));
        ...
        actionBar.setSubtitle("Search by Tasting Notes");
